...
class DataHandler():
    ...
    def _prep_data(self):
        ...
        # Convert all column names to string before checking if they contain 'Unnamed'
        string_columns = temp_df.columns.astype(str).str.contains('^Unnamed')
        self.df = temp_df.loc[:, ~string_columns]
